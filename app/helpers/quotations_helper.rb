module QuotationsHelper
  def get_terms_and_conditions
    ...
    ApplicationHelper::NAME + ', does not take any responsibility for the loss or theft of personal belongings at the Venue',
    'Cheque Should be issued in favor of  M/s ' + ApplicationHelper::NAME,
    ...
    'Payment to make in favor of "' + ApplicationHelper::NAME + '" payable in Bangalore.',
    ...
    'During show rig and de-rig, ' + ApplicationHelper::NAME + ' personnel will ensure care is displayed with regards to the Venue/site. However, we cannot be held responsible for any damage caused during the normal Construction and transportation of our equipper.',
    'Although ' + ApplicationHelper::NAME + ' will use all reasonable endeavors to meet its obligations in a prompt and efficient manner, it does not accept responsibility for any failure or delay caused by circumstances beyond its control.',
    ...
    'If the equipment is seized, withheld, confiscated or detained for any reason whatsoever it is your responsibility to restore it back to ' + ApplicationHelper::NAME + ' in its original state and all expenses towards it Reinstatement is completely yours.',
