class PaymentsController < ApplicationController
  ...
  def print
    respond_to do |format|
      format.pdf do
        pdf = PrintPayment.new(params[:payment_id], params[:email])
  ...
  private
    ...
    def payment_params
      params.require(:payment).permit(:client_id, :description, :mode, :paid_on, :amount, :payment_type, :paid_to, :payment_added_by, :payment_last_modified_by)
    end
end
